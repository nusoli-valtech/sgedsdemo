...
- [x] 02-04-mustache-template-PLAN.md — Wave 1: author `cf-templates/article.html` Mustache template (autonomous:true; CFO-03)
- [x] 02-05-article-hero-rewrite-PLAN.md — Wave 2: rewrite `blocks/article-hero/article-hero.js` + add `_article-hero.json` (autonomous:true; CFO-04, CFO-05, CFO-06, CFO-07, CFO-09)
- [x] 02-06-article-teaser-rewrite-PLAN.md — Wave 2: rewrite `blocks/article-teaser/article-teaser.js` + add `_article-teaser.json` + `head.html` cf-endpoint meta (autonomous:true; CFO-04, CFO-05, CFO-06, CFO-07, CFO-08, CFO-09)
- [x] 02-07-doc-content-fragment-overlay-PLAN.md — Wave 3: author `docs/content-fragment-overlay.md` end-to-end (autonomous:true; CFO-10, DOC-01)
...
| 2. Content Fragment Overlay | 7/8 | In Progress|  |
